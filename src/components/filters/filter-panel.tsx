    ...
    >
      ...
      <div className="border border-white/8 rounded-xl bg-white/5 overflow-hidden transition-all duration-200">
        <button
          ...
          aria-controls="role-type-content"
        ...
        {isRoleOpen && (
          <div id="role-type-content" className="px-2.5 pb-2.5 pt-1 border-t border-white/5 bg-white/[0.02]">
      ...
      <div className="border border-white/8 rounded-xl bg-white/5 overflow-hidden transition-all duration-200">
        <button
          ...
          aria-controls="experience-level-content"
          className="w-full flex items-center justify-between px-3 py-2.5 hover:bg-white/5 transition-colors text-left"
        >
          <div className="flex items-center gap-2">
            <span className="text-[11px] font-bold uppercase tracking-wider text-muted-foreground">
        ...
        {isLevelOpen && (
          <div id="experience-level-content" className="px-2.5 pb-2.5 pt-1.5 border-t border-white/5 bg-white/[0.02]">
